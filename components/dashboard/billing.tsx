...
export function Billing({ cart, setCart, history, setHistory, menuList }: { cart: CartItem[]; setCart: (cart: CartItem[]) => void; history: BillingRecord[]; setHistory: (history: BillingRecord[]) => void; menuList: MenuItem[] }) {
