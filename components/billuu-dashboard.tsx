          ...
          <main className="mx-auto max-w-[1600px] p-5 md:p-8">
            {view === 'New order' ? (
              ...
              <div className="flex min-h-[60vh] flex-col items-center justify-center rounded-2xl border border-dashed border-[#c9bfa8] bg-[#fffdf7] text-center">
                ...
                <h2 className="mt-4 text-lg font-bold text-[#3a3020]">
                  {view} workspace
                </h2>
                <p className="mt-1 max-w-sm text-sm text-[#8a7f6c]">
                  This section is ready for API data and workflows. Start a new
                  order to explore the core POS flow.
                </p>
                <button
                  onClick={() => setView('New order')}
                  className="mt-5 rounded-xl bg-[#4f5e2e] px-4 py-3 text-sm font-bold text-white"
                >
                  Open POS
                </button>
              </div>
